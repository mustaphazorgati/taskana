...
public class TaskanaEngineConfiguration {
  ...
  public void initTaskanaProperties(String propertiesFile, String separator) {
    ...
    parseProperty(props, TASKANA_GERMAN_HOLIDAYS_ENABLED, Boolean::parseBoolean)
        .ifPresent(this::setGermanPublicHolidaysEnabled);
    parseProperty(props, TASKANA_GERMAN_HOLIDAYS_CORPUS_CHRISTI_ENABLED, Boolean::parseBoolean)
        .ifPresent(this::setCorpusChristiEnabled);
    parseProperty(props, TASKANA_HISTORY_DELETION_ON_TASK_DELETION_ENABLED, Boolean::parseBoolean)
        .ifPresent(this::setDeleteHistoryOnTaskDeletionEnabled);
  ...
  private void initTaskanaRoles(Properties props, String rolesSeparator) {
        ...
        role -> {
          List<String> accessIds =
              splitStringAndTrimElements(
                  ...
                  rolesSeparator,
                  shouldUseLowerCaseForAccessIds() ? String::toLowerCase : Function.identity());
    ...
    if (LOGGER.isDebugEnabled()) {
      roleMap.forEach((k, v) -> LOGGER.info("Found Taskana RoleConfig {} : {} ", k, v));
    }
  }
  ...
  private List<String> splitStringAndTrimElements(String str, String separator) {
    return splitStringAndTrimElements(str, separator, Function.identity());
  }

  private List<String> splitStringAndTrimElements(
      String str, String separator, Function<String, String> modifier) {
